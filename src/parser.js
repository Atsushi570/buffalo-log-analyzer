...
export const EVENT_DEFS = [
  ...
  { id: 'dhcpc_nak',       cat: 'DHCPC', label: 'IP拒否 (NAK)',            kind: 'dhcp',  severity: 'error',
    re: /^DHCPNAK/ },
  { id: 'dhcpc_arping_err',cat: 'DHCPC', label: 'ARPINGエラー',            kind: 'dhcp',  severity: 'error',
  ...
  { id: 'dhcps_pool_empty',cat: 'DHCPS', label: 'IPプール枯渇',            kind: 'dhcp',  severity: 'critical',
    re: /^Unable to pick client address: (.+)$/, fields: m => ({ detail: m[1] }) },
  { id: 'dhcps_arping_err',cat: 'DHCPS', label: 'ARPINGエラー',            kind: 'dhcp',  severity: 'error',
    re: /^Error on ARPING request: (.+)$/, fields: m => ({ detail: m[1] }) },
